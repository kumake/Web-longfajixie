					...
					<tr>
						...
						<table id="__01" width="729" height="475" border="0" cellpadding="0" cellspacing="0">
							<tr>
								...
								<div style="padding-top:20px; font-weight:bold; margin-left:15px; width:100px;float:left;">招聘信息</div>
								<div style="padding-top:20px;  margin-right:3px; float:right;width:200px; text-align:right">当前位置 > <a href="index.asp">首页</a> > <a href="zpxx.asp">招聘信息</a></div>
								</td>
							</tr>
							<tr>
								...
								<%
												...
												'''''模型表名称
												Dim ModelTable:ModelTable ="user_zpxx"
											...
											%>
											  <%
														...
														set rs = UICon.Query("select * from user_zpxx where ID="&ItemID&"")
														UIcon.execute("update user_zpxx set Hots=Hots +1 where id="&ItemID&"")
											  ...
											  <table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
													  ...
													  <table width="100%" border="0" cellspacing="0" cellpadding="0">
														<tr>
														  <td height="35" align="left" valign="middle" class="news_fabutime" style="font-weight: bold">发布时间：<%=rs("posttime")%></td>
															...
															上一篇信息：
																<%
													set rsu = Uicon.query("select top 1 id,categoryid,title from user_zpxx where categoryid="&categoryid&" and id<"&itemid&" order by id desc")
												...
												<tr>
												  <td height="26">下一篇信息：
													<%
													set rsn = Uicon.query("select top 1 id,categoryid,title from user_zpxx where categoryid="&categoryid&" and id>"&itemid&" order by id asc")
													if rsn.recordcount<>0 then 
														response.Write "<a href='?categoryid="&rsn("categoryid")&"&itemid="&rsn("id")&"'  >"&rsn("title")&"</a>"
													else
														response.Write "已经是最后一篇信息了"
													end if
													%></td>
															</tr>
												<tr>
